...
Language.es = function(){
    ...
    Language.clientnamewarning = "Introduzca uno o más nombres";
    Language.clientlastnamewarning = "Introduzca uno o más apellidos";
...
function updateLanguage(){
    ...
    /*   
     ...
     updateText("contact", Language.contact);
     updateText("sitemap", Language.sitemap);
     updateText("welcome", Language.welcome);
     updateText("loggedout", Language.loggedout);
     
     //Content:
     $(".promo").css("background-image", "url(" + Language.promoImg + ")");
     updateText("promo", Language.promo);
     updateText("highlights", Language.highlights);
     updateText("categories", Language.categories);
     updateText("price", Language.price);
     updateText("language", Language.language);
     updateText("subtitles", Language.subtitles);
     updateText("categories2", Language.categories2);
     updateText("catalog_recommendation", Language.tx_catalog_recommendation);
     updateText("salesrank", Language.salesrank);
     updateText("seeMore", Language.seeMore);
     updateText("addToCart", Language.addToCart);
     updateText("category", Language.category);
     updateText("subcategory", Language.category);
     
     updateText("cart", Language.cart);
     
     //Settings:
     updateText("modify_account_settings", Language.modify_account_settings);
     
     //LogForm:
     updateText("close", Language.close);
     
     //Forms:
     updateText("create_address", Language.createaddress);
     updateText("create_address_intro", Language.createaddressintro);
     updateText("create_account", Language.createaccount);
     updateText("change_password", Language.changepassword);
     updateText("update_account", Language.updateaccount);
     updateText("update_address", Language.update_address);
     updateText("mandatory_fields", Language.mandatoryfields);
     updateText("terms", Language.terms);
     updateText("name", Language.name);
     updateText("full_name", Language.fullname);
     updateText("username", Language.username);
     updateText("password", Language.password);
     updateText("confirm_password", Language.confirmpassword);
     updateText("current_password", Language.currentpassword);
     updateText("new_password", Language.newpassword);
     updateText("email", Language.email);
     updateText("birth_date", Language.birthdate);
     updateText("address1", Language.address1);
     updateText("address2", Language.address2);
     updateText("country", Language.country);
     updateText("state", Language.state);
     ...
     updateText("error_no_login", Language.error_no_login);
     updateText("order", Language.order);
     updateText("status", Language.status);
     updateText("adress", Language.adress);
     updateText("created", Language.created);
